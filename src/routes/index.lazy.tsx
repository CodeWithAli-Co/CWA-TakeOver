...
import { Calendar } from "@/components/ui/shadcnComponents/calendar";
...
const NavItem = ({
  ...
  <Button
    variant="ghost"
    className="text-amber-50/70 hover:text-amber-50 hover:bg-red-900/20 gap-2"
  >
  ...
  >
    <div className="flex items-center gap-3">
      ...
      <div>
        ...
        <p className="text-xs text-amber-50/70 group-hover:text-amber-50">
          {count}
        </p>
      </div>
    </div>
      ...
      <nav className="border-b border-red-900/30 bg-black/40 sticky top-0 z-50">
        <div className="flex items-center justify-between h-14 px-6">
          ...
          <div className="flex items-center space-x-4">
            <Button
              variant="ghost"
              className="text-amber-50/70 hover:text-amber-50 relative"
            >
            ...
            <CardContent>
              <ScrollArea className="h-[200px]">
                <div className="space-y-3">
                  {[
                    {
                      title: "Indeed Integration Review",
                      time: "2:00 PM",
                      date: "Today",
                      attendees: 4,
                    },
                    {
                      title: "LinkedIn API Discussion",
                      time: "10:00 AM",
                      date: "Tomorrow",
                      attendees: 6,
                    },
              ...
              <ScrollArea className="h-[300px]">
                <div className="space-y-4">
                  {[
                    {
                      type: "webhook",
                      title: "Indeed Webhook Triggered",
                      time: "2 mins ago",
                      status: "success",
                    },
                    {
                    ...
                    >
                      ...
                      >
                        {activity.type === "webhook" && (
                          <Webhook className="h-4 w-4 text-current" />
                        )}
                        {activity.type === "api" && (
