...
const MetricCard = ({
  ...
  <motion.div
    ...
    className="p-4 rounded-lg bg-card/10 border border-red-900/30"
  >
...
export const DeveloperResourceHub = () => {
  return (
    <Card className="bg-card/10 rounded-xs border-red-900/30 lg:col-span-2">
      <CardHeader>
        <div className="flex items-center justify-between">
      ...
      <CardContent>
        <Tabs defaultValue="performance" className="space-y-4">
          <TabsList className="bg-card/10 rounded-xs border border-red-900/30">
            <TabsTrigger
              value="performance"
          ...
          <TabsContent value="performance" className="space-y-4">
            ...
            <Card className="bg-card/10 border-red-900/30  rounded-xs">
                  ...
                  <div className="space-y-2">
                    {[
                      ...
                      <ResourceMetric
                        ...
                        {...metric}
                        status={
                          metric.status as "normal" | "warning" | "critical"
                        }
                      />
                    ))}
                  </div>
          ...
          <TabsContent value="resources" className="space-y-4">
            ...
            <Card className="bg-card/10 border-red-900/30">
              <CardContent className="pt-4">
                <h3 className="text-sm font-medium text-amber-50 mb-3">
                  Resource Allocation
                </h3>
