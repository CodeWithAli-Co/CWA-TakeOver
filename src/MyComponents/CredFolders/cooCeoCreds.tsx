...
export const CooCeoCreds = () => {
  return (
    ...
    <div className="p-4 bg-background  flex items-center">
        <Link 
          to="/details" 
          className="bg-background flex justify-center items-center border p-2 pr-5 border-red-950 hover:bg-red-950 text-foreground hover:border-red-900 hover:text-black group"
        >
