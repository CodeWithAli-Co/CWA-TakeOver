...
export const QuotaItem = ({
  ...
  return (
    <motion.div
      ...
      exit={{ opacity: 0, y: -10 }}
      className="p-4 rounded-lg border border-zinc-900 bg-zinc-950 high-dpi:bg-zinc-950/20 hover:border-red-800/50 mb-3"
    >
        ...
        <div className="space-y-4 py-4">
          <div className="space-y-2">
            ...
            <Input
              ...
              className="bg-zinc-950 high-dpi:bg-zinc-950/20 border-zinc-900 text-amber-50"
              required
            />
          </div>
          <div className="space-y-2">
          ...
          <div className="space-y-2">
            ...
            <Select value={status} onValueChange={setStatus}>
              <SelectTrigger className="bg-zinc-950 high-dpi:bg-zinc-950/20 border-zinc-900 text-amber-50">
...
export const WeeklyQuotas = () => {
  ...
  return (
    <div className="min-h-screen bg-black overflow-y-auto">
      {/* Navigation Bar */}
      <nav className="border-b border-zinc-900 bg-zinc-950 high-dpi:bg-zinc-950/20 sticky top-0 z-50 py-6">
        <div className="flex items-center justify-between h-14 px-6">
          <div className="flex items-center space-x-4">
            <h1 className="text-white font-bold">Weekly Quotas</h1>
          </div>
        </div>
      </nav>
      ...
      >
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          ...
          <motion.div
            ...
            className="bg-zinc-950 high-dpi:bg-zinc-950/20 border border-zinc-900 rounded-lg p-4"
          >
        ...
        {/* Main Quotas Card */}
        <Card className="bg-zinc-950 high-dpi:bg-zinc-950/20 border-zinc-900 rounded-xs">
          ...
          <CardContent>
            <div className="flex justify-between items-center mb-4">
              <Input
                ...
                className="w-[300px] bg-zinc-950 high-dpi:bg-zinc-950/20 border-zinc-900 text-amber-50"
              />
            ...
            <Tabs
              ...
              className="mb-4"
            >
              <TabsList className="bg-zinc-950 high-dpi:bg-zinc-950/20 border border-zinc-900">
                <TabsTrigger
                  value="pending"
