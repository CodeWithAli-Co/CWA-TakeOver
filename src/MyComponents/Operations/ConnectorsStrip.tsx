...
import { useConnectors, type Connector } from "@/stores/connectors";
import {
  getCatalogEntry,
  Monogram,
...
function MiniCard({ connector }: { connector: Connector }) {
  ...
  return (
    <div className="shrink-0 w-[200px] rounded-xl border-xs border-border-soft bg-foreground/[0.03] hover:bg-foreground/[0.05] transition-colors px-3 py-2.5">
