...
import { adobeLogo, airtableLogo, asanaLogo, awsLogo, azureLogo, behanceLogo, binanceLogo, bitbucketLogo, calendlyLogo, CanvaLogo, cloudflareLogo, codepenLogo, coinbaseLogo, digitaloceanLogo, discordLogo, dribbleLogo, etsyLogo, fiverrLogo, gitlabLogo, gmailLogo, godaddyLogo, googlecloudLogo, googleworkspaceLogo, herokuLogo, hostingerLogo, hubspotLogo, jiraLogo, mailchimpLogo, mediumLogo, microsoftofficeLogo, namecheapLogo, netlifyLogo, notionLogo, npmLogo, patreonLogo, paypalLogo, pinterestLogo, quoraLogo, redditLogo, robinhoodLogo, salesforceLogo, shopifyLogo, slackLogo, snapchatLogo, stackexchangeLogo, stackoverflowLogo, stripeLogo, substackLogo, telegramLogo, tiktokLogo, trelloLogo, twitchLogo, upworkLogo, vercelLogo, whatsappLogo, wordpressLogo } from "../ImgToIcon";
...
export const platformIcons: Record<string, IconComponent> = {
  ...
  godaddy: godaddyLogo,
  stackexchange: stackexchangeLogo,
  ...
  microsoftoffice: microsoftofficeLogo,
  notion: notionLogo,
