...
const customSelectStyles = {
  ...
  option: (provided: any, state: any) => ({
    ...provided,
    backgroundColor: state.isSelected ? '#B91C1C' : state.isFocused ? 'rgba(185, 28, 28, 0.5)' : 'transparent',
    color: '#FFFFFF',
    '&:hover': {
...
export const AddDMGroup = (props: Subscribers) => {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black/80 backdrop-blur-sm p-4">
      <div className="bg-gradient-to-b from-black to-red-950/30 border border-red-800 rounded-lg 
