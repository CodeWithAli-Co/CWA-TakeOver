...
import { DynamicItemProps, ExpenseItem, RevenueItem } from '@/stores/FinancialField';


// Expense/Revenue item component with delete capability
const DynamicItem: React.FC<DynamicItemProps> = ({ item, onChange, onDelete, type, categories }) => {
