      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-4 mb-6">
        <Card className="bg-black/40 border-red-950/20">
          <CardContent className="p-4">
            ...
            <p className="text-2xl font-bold text-red-200 mt-2">{stats.completed}</p>
          </CardContent>
        </Card>
        <Card className="bg-black/40 border-red-950/20">
          <CardContent className="p-4">
            ...
            <p className="text-2xl font-bold text-red-200 mt-2">{stats.inProgress}</p>
          </CardContent>
          </Card>
        <Card className="bg-black/40 border-red-950/20">
          <CardContent className="p-4">
            ...
            <p className="text-2xl font-bold text-red-200 mt-2">{stats.todo}</p>
          </CardContent>
        </Card>
        <Card className="bg-black/40 border-red-950/20">
          <CardContent className="p-4">
            ...
            <p className="text-2xl font-bold text-red-200 mt-2">{stats.total}</p>
          </CardContent>
        </Card>
      </div>
