...
const reportTemplates: ReportTemplate[] = [
  {
    ...
    type: "security",
    description: "Overview of security incidents, severity levels, and resolution status.",
  ...
  },
  {
    ...
    type: "performance",
    description: "Analysis of system performance metrics, response times, and resource usage.",
  ...
  },
  {
    ...
    type: "audit",
    description: "Comprehensive audit report for compliance with security policies and regulations.",
    availableFormats: ["pdf", "excel"]
  },
  {
    id: "template-005",
    ...
    type: "custom",
    description: "Customizable report for exporting specific data based on selected filters.",
...
const ReportTypeIcon = ({ type }) => {
  switch (type) {
    ...
    case "activity":
      return <Badge variant="outline" className="bg-blue-500/20 text-blue-400 border-blue-500/30 flex items-center gap-1">
    ...
    case "audit":
      return <Badge variant="outline" className="bg-amber-500/20 text-amber-400 border-amber-500/30 flex items-center gap-1">
        <Clipboard className="h-3 w-3" />
        Audit
      </Badge>;
    case "custom":
      return <Badge variant="outline" className="bg-purple-500/20 text-purple-400 border-purple-500/30 flex items-center gap-1">
...
const ReportFormatIcon = ({ format }) => {
  switch (format) {
    case "pdf":
      return <Badge variant="outline" className="bg-red-500/10 text-red-400 border-red-500/20 flex items-center gap-1">
        <FileText className="h-3 w-3" />
        PDF
      </Badge>;
    case "csv":
      return <Badge variant="outline" className="bg-green-500/10 text-green-400 border-green-500/20 flex items-center gap-1">
        <FileSpreadsheet className="h-3 w-3" />
        CSV
      </Badge>;
    case "excel":
      return <Badge variant="outline" className="bg-blue-500/10 text-blue-400 border-blue-500/20 flex items-center gap-1">
        <FileSpreadsheet className="h-3 w-3" />
        Excel
      </Badge>;
    case "json":
      return <Badge variant="outline" className="bg-amber-500/10 text-amber-400 border-amber-500/20 flex items-center gap-1">
        <FilePieChart className="h-3 w-3" />
        JSON
      </Badge>;
    default:
      return <Badge variant="outline" className="bg-gray-500/10 text-gray-400 border-gray-500/20">
        Unknown
      </Badge>;
  }
};
...
const ScheduleBadge = ({ schedule }) => {
  switch (schedule) {
    case "manual":
      return <Badge variant="outline" className="bg-gray-500/10 text-red-200 border-red-900/20">
        Manual
      </Badge>;
    case "daily":
      return <Badge variant="outline" className="bg-blue-500/10 text-red-200 border-red-900/20">
        Daily
      </Badge>;
    case "weekly":
      return <Badge variant="outline" className="bg-green-500/10 text-red-200 border-red-900/20">
        Weekly
      </Badge>;
    case "monthly":
      return <Badge variant="outline" className="bg-purple-500/10 text-red-200 border-red-900/20">
        Monthly
      </Badge>;
    default:
      return <Badge variant="outline" className="bg-gray-500/10 text-gray-400 border-gray-500/20">
      ...
      <DialogContent className="sm:max-w-[600px] bg-black/95 border-red-950/30 text-red-200">
        ...
        <div className="py-4 space-y-4">
          <div className="space-y-2">
            <Label htmlFor="template" className="text-red-200">Report Template</Label>
            <Select value={selectedTemplate} onValueChange={setSelectedTemplate}>
              <SelectTrigger id="template" className="bg-black/40 border-red-950/30 text-red-200">
                <SelectValue placeholder="Select a report template" />
              </SelectTrigger>
              <SelectContent className="bg-black/95 border-red-950/30 text-red-200">
                {templates.map(template => (
                  <SelectItem key={template.id} value={template.id} className="text-red-200 hover:bg-red-950/30">
          ...
          <div className="space-y-2">
            <Label htmlFor="report-name" className="text-red-200">Report Name</Label>
            <Input 
              id="report-name" 
              value={reportName} 
          ...
          {selectedTemplateData && (
            <div className="space-y-2">
              <Label htmlFor="format" className="text-red-200">Report Format</Label>
              <Select value={reportFormat} onValueChange={setReportFormat}>
                <SelectTrigger id="format" className="bg-black/40 border-red-950/30 text-red-200">
                  <SelectValue placeholder="Select format" />
                </SelectTrigger>
                <SelectContent className="bg-black/95 border-red-950/30 text-red-200">
                  {selectedTemplateData.availableFormats.map(format => (
                    <SelectItem key={format} value={format} className="text-red-200 hover:bg-red-950/30">
                      <div className="flex items-center gap-2">
                        ...
                        {format === "json" && <FilePieChart className="h-4 w-4" />}
                        {format.toUpperCase()}
                      </div>
                    </SelectItem>
                  ))}
          ...
          <div className="space-y-2">
            <Label htmlFor="schedule" className="text-red-200">Schedule</Label>
            <Select value={schedule} onValueChange={setSchedule}>
              <SelectTrigger id="schedule" className="bg-black/40 border-red-950/30 text-red-200">
                <SelectValue placeholder="Select schedule" />
              </SelectTrigger>
              <SelectContent className="bg-black/95 border-red-950/30 text-red-200">
                <SelectItem value="manual" className="text-red-200 hover:bg-red-950/30">Manual Generation</SelectItem>
                <SelectItem value="daily" className="text-red-200 hover:bg-red-950/30">Daily</SelectItem>
                <SelectItem value="weekly" className="text-red-200 hover:bg-red-950/30">Weekly</SelectItem>
                <SelectItem value="monthly" className="text-red-200 hover:bg-red-950/30">Monthly</SelectItem>
              </SelectContent>
            </Select>
          </div>
          
          <div className="space-y-2">
            <Label htmlFor="recipients" className="text-red-200">Email Recipients (comma-separated)</Label>
            <Input 
              id="recipients" 
              value={recipients} 
          ...
          <div className="flex items-center space-x-2">
            <Checkbox id="notify" className="data-[state=checked]:bg-red-900 data-[state=checked]:border-red-900" />
            <Label htmlFor="notify" className="text-red-200">Notify me when report is generated</Label>
          </div>
        </div>
    ...
    <Card className="bg-black/40 border-red-900/30 overflow-hidden hover:border-red-900/50 transition-all duration-200">
      <CardHeader className="pb-2">
        <div className="flex justify-between items-start">
          <div>
            <CardTitle className="text-red-200 text-base font-medium">{report.name}</CardTitle>
            <CardDescription className="text-red-200/60 text-xs">
              Last generated: {report.lastGenerated ? new Date(report.lastGenerated).toLocaleString() : "Never"}
            </CardDescription>
          </div>
          ...
          >
            <TabsContent value="all" className="mt-4 space-y-4">
              <Card className="bg-black/60 border-red-950/30 backdrop-blur-sm">
                <CardHeader className="pb-2">
                  <CardTitle className="text-white text-lg">All Reports</CardTitle>
                ...
                <CardContent>
                  {filteredReports.length > 0 ? (
                    ...
                    <div className="flex flex-col items-center justify-center text-center py-10">
                      ...
                      <h3 className="text-lg font-medium text-red-200 mb-1">No reports found</h3>
            ...
            <TabsContent value="performance" className="mt-4 space-y-4">
              <Card className="bg-black/60 border-red-950/30 backdrop-blur-sm">
                <CardHeader className="pb-2">
                  <CardTitle className="text-white text-lg">Performance Reports</CardTitle>
                  <CardDescription className="text-red-200/60">
                ...
                <CardContent>
                  {filteredReports.length > 0 ? (
                    ...
                    <div className="flex flex-col items-center justify-center text-center py-10">
                      ...
                      <h3 className="text-lg font-medium text-red-200 mb-1">No performance reports found</h3>
                      <p className="text-sm text-red-200/60 mb-6">
                        Create performance reports to monitor system metrics and resources
                      </p>
                      <NewReportDialog templates={reportTemplates} onSave={handleAddReport} />
                    </div>
                  )}
                ...
                <CardContent>
                  {filteredReports.length > 0 ? (
                    ...
                    <div className="flex flex-col items-center justify-center text-center py-10">
                      ...
                      <h3 className="text-lg font-medium text-red-200 mb-1">No audit reports found</h3>
                      <p className="text-sm text-red-200/60 mb-6">
                        Create audit reports for compliance and governance requirements
                      </p>
                      <NewReportDialog templates={reportTemplates} onSave={handleAddReport} />
                    </div>
                  )}
                ...
                <CardContent>
                  {filteredReports.length > 0 ? (
                    ...
                    <div className="flex flex-col items-center justify-center text-center py-10">
                      ...
                      <h3 className="text-lg font-medium text-red-200 mb-1">No custom reports found</h3>
                      <p className="text-sm text-red-200/60 mb-6">
                        Create custom reports tailored to your specific requirements
                      </p>
                      <NewReportDialog templates={reportTemplates} onSave={handleAddReport} />
                    </div>
                  )}
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {reportTemplates.map(template => (
              <Card key={template.id} className="bg-black/40 border-red-900/30 hover:border-red-900/50 transition-all duration-200">
                <CardHeader className="pb-2">
                  <div className="flex justify-between items-center">
                    <CardTitle className="text-red-200 text-base font-medium">{template.name}</CardTitle>
                    <ReportTypeIcon type={template.type} />
                  </div>
                </CardHeader>
                <CardContent className="py-2">
                  <p className="text-xs text-red-200/70 mb-3">{template.description}</p>
        ...
        <CardContent className="space-y-4">
          <div className="flex items-center justify-between">
            <div className="space-y-0.5">
              <Label className="text-base text-red-200">Email Notifications</Label>
          ...
          <div className="flex items-center justify-between">
            <div className="space-y-0.5">
              <Label className="text-base text-red-200">Default Report Format</Label>
              <p className="text-sm text-red-200/60">
            ...
            <Select defaultValue="pdf">
              ...
              <SelectContent className="bg-black/95 border-red-950/30 text-red-200">
                <SelectItem value="pdf" className="text-red-200 hover:bg-red-950/30">PDF Document</SelectItem>
                <SelectItem value="csv" className="text-red-200 hover:bg-red-950/30">CSV Spreadsheet</SelectItem>
                <SelectItem value="excel" className="text-red-200 hover:bg-red-950/30">Excel Workbook</SelectItem>
                <SelectItem value="json" className="text-red-200 hover:bg-red-950/30">JSON Data</SelectItem>
              </SelectContent>
            </Select>
          </div>
          ...
          <div className="flex items-center justify-between">
            <div className="space-y-0.5">
              <Label className="text-base text-red-200">Report Retention Period</Label>
              <p className="text-sm text-red-200/60">
            ...
            <Select defaultValue="90">
              ...
              <SelectContent className="bg-black/95 border-red-950/30 text-red-200">
                <SelectItem value="30" className="text-red-200 hover:bg-red-950/30">30 Days</SelectItem>
                <SelectItem value="60" className="text-red-200 hover:bg-red-950/30">60 Days</SelectItem>
                <SelectItem value="90" className="text-red-200 hover:bg-red-950/30">90 Days</SelectItem>
                <SelectItem value="180" className="text-red-200 hover:bg-red-950/30">180 Days</SelectItem>
                <SelectItem value="365" className="text-red-200 hover:bg-red-950/30">1 Year</SelectItem>
                <SelectItem value="forever" className="text-red-200 hover:bg-red-950/30">Forever</SelectItem>
              </SelectContent>
            </Select>
          </div>
          ...
          <div className="flex items-center justify-between">
            <div className="space-y-0.5">
              <Label className="text-base text-red-200">Automatic Report Generation</Label>
              <p className="text-sm text-red-200/60">
                Allow scheduled reports to generate automatically
              </p>
            </div>
            <Switch defaultChecked className="data-[state=checked]:bg-red-900" />
          </div>
        </CardContent>
