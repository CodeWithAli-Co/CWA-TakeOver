/**
 * Sheet — Theme-aware slide-out panel.
 *
 * Used for side panels (left/right) and drawers (top/bottom). Matches Dialog
 * styling: bg-card panel with border-border and primary close btn.
...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-card border-border p-6 shadow-2xl shadow-black/50 transition-colors ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500 data-[state=open]:animate-in data-[state=closed]:animate-out",
  {
    variants: {
      side: {
