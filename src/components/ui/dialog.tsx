 ...
 * - Content: bg-card with subtle border border, rounded-sm
...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed left-[50%] top-[50%] z-50 grid w-full max-w-lg translate-x-[-50%] translate-y-[-50%] gap-4 bg-card border border-border rounded-sm p-6 shadow-2xl shadow-black/50 duration-200",
    ...
    >
      {children}
      <DialogPrimitive.Close hidden className="hidden absolute right-3 top-3 p-1.5 rounded-sm text-muted-foreground hover:text-primary hover:bg-primary/[0.08] transition-colors focus:outline-none focus:ring-1 focus:ring-primary/30 disabled:pointer-events-none">
